...
export function ResumeReviewView({ sourceFile, extracted, analyzing, error, envConfigured, clientConfigured, onClientChanged, onConfirm, onBack }: ResumeReviewViewProps) {
  ...
  return (
    <div className="min-h-screen bg-bg px-4 py-6 sm:px-6 sm:py-8">
      <div className="mx-auto w-full max-w-[1360px]">
        ...
        <div className="grid grid-cols-[260px_minmax(0,1fr)] gap-5 max-lg:grid-cols-1">
          ...
          <main className="min-w-0 overflow-hidden rounded-lg border border-line bg-white shadow-card">
            <div className="flex min-h-12 flex-wrap items-center gap-y-2 border-b border-line px-4 py-2 sm:px-5" role="tablist" aria-label="简历检查视图">
              ...
              <span className="ml-auto flex flex-wrap items-center justify-end gap-1.5 text-[12px] text-text-tertiary">
                <span className="flex-none max-[680px]:hidden">已保留 {selectedCandidates.length} / {candidates.length} 条</span>
                <span className="mx-1 h-4 w-px flex-none bg-line max-[680px]:hidden" />
