...
import { ReportBlindSpots } from '@/features/report/ReportBlindSpots'
import { ReportClaimList } from '@/features/report/ReportClaimList'
...
export function InterviewReportView({
  ...
  return (
    <div className="space-y-3 pb-6">
      ...
      {/* 主从布局：左侧要点列表 + 右侧单条复盘 */}
      <div className="grid grid-cols-[292px_minmax(0,1fr)] items-start gap-3 max-[980px]:grid-cols-1">
        <div className="min-[981px]:sticky min-[981px]:top-0">
          <ReportClaimList
            reports={reports}
        ...
        <article className="min-w-0 overflow-hidden rounded-lg bg-white shadow-card ring-1 ring-black/[0.03]">
