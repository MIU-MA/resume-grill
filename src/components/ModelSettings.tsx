...
// text-field 复用样式
const inputCls = 'h-8 rounded-[4px] border border-line-strong bg-white px-[11px] text-[12px] text-[#283136] focus:border-brand focus:outline-brand'
  ...
  return (
    <div className="overflow-hidden rounded-lg border border-line bg-white shadow-[0_12px_40px_rgba(27,40,34,.1)]">
      <div className="border-b border-line bg-[#fafbfb] px-3 py-2">
        <span className={cn('inline-flex h-[21px] items-center gap-[5px] rounded-[3px] px-2 text-[10px] font-650 whitespace-nowrap', CHIP_VARIANT[mode.cls])}>
          <i className="size-[6px] flex-none rounded-full bg-current" />{mode.label}
        </span>
      </div>
      <div className="flex flex-col gap-3 p-3">
        <label className="flex flex-col gap-1">
          <span className="text-[10px] font-700 text-[#4e585e]">Base URL</span>
        ...
        <label className="flex flex-col gap-1">
          <span className="text-[10px] font-700 text-[#4e585e]">API Key</span>
        ...
        <label className="flex flex-col gap-1">
          <span className="text-[10px] font-700 text-[#4e585e]">Model</span>
        ...
        <p className="m-0 text-faint text-[10px] leading-[1.5]">
