...
export function InterviewComposer({
  ...
  return (
    <div className="flex-none border-t border-line bg-white px-6 py-4 max-[640px]:px-3">
            ...
            <div className="flex items-center justify-between gap-3 max-[640px]:items-end">
              ...
              <div className="ml-auto flex flex-wrap items-center justify-end gap-2">
                {speech.supported && (
                  ...
                  >
                    {speech.listening ? <><Square size={14} />停止语音</> : <><Mic size={15} />语音输入</>}
                  </Button>
                )}
                ...
                <Button variant="primary" size="large" disabled={!canSubmit} onClick={onSubmit} loading={loading}>
