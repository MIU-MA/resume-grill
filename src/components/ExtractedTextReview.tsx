  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-canvas px-5 py-10">
      <div className="w-full max-w-[540px] rounded-[4px] border border-line border-t-[3px] border-t-brand bg-surface px-7 pt-7 pb-[26px] shadow-[0_1px_0_var(--color-line),0_8px_24px_rgba(27,40,34,.04)]">
        <div className="mb-[6px] text-brand text-[9px] font-750 tracking-[0.08em]">文本确认</div>
        ...
        <div className="mb-3 flex items-center gap-[14px] text-muted text-[10px]">
        ...
        <textarea
          className="w-full min-h-[260px] resize-y rounded-[4px] border border-line-strong bg-white p-[11px] text-[11px] leading-[1.7] text-[#283136] focus:border-brand focus:outline-2 focus:outline-brand focus:outline-offset-[-1px]"
          value={text}
