...
Resume Grill 将简历中的项目、技能和成果转化为能力测试，通过连续追问检查实际场景、实现过程、技术原理、方案取舍和能力边界，自动收录追问中暴露的漏洞与待补强知识点，并根据回答生成简历表达建议。
...
|  漏洞与知识点 | 自动收录追问中的「没听懂」批注与总结出的待补强知识点，可增删改、标记已掌握，跨简历持久保存 |
|  能力清单 | 声明按优先级排序，已完成的测试标绿色，点击即可发起测试 |
...
<table>
  ...
  <tr>
    ...
    <td align="center"><strong>查漏补缺</strong><br/>汇总漏洞与待补强知识点，标记掌握、增删改</td>
  </tr>
  <tr>
...
| 面试记录 | 浏览器 IndexedDB |
| 漏洞与知识点 | 浏览器 IndexedDB（全局独立存储，跨简历累积） |
